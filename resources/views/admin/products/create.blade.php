    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 fw-bold"><i class="fas fa-info-circle me-2"></i>General Details</h5>
            </div>
            <div class="card-body">
                <div class="row">
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label class="form-label">Upload Gallery Images (Select multiple)</label>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-dark text-white py-3 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold">Product Shades</h5>
                <button type="button" id="add-shade" class="btn btn-light btn-sm fw-bold">+ Add Shade Row</button>
            </div>
        ...
        let html = `
            <div class="row shade-row border p-3 mb-3 bg-white rounded shadow-sm align-items-start">
                <div class="col-md-3 mb-2">
                    ...
                    <input type="text" name="shades[${count}][shade_name]" class="form-control" placeholder="e.g. Rose Pink" required>
                </div>
                <div class="col-md-1 mb-2">
                    <label class="small fw-bold text-muted">Color</label>
                    <input type="color" name="shades[${count}][hex_code]" class="form-control p-1" style="height: 38px;">
                </div>
                <div class="col-md-2 mb-2">
                    <label class="small fw-bold text-muted">Price</label>
                    <input type="number" step="0.01" name="shades[${count}][price]" class="form-control" placeholder="0.00" required>
                </div>
                <div class="col-md-1 mb-2">
                    <label class="small fw-bold text-muted">Stock</label>
                    <input type="number" name="shades[${count}][stock]" class="form-control" placeholder="0" required>
                </div>
                <div class="col-md-4 mb-2">
                    <label class="small fw-bold text-muted">Shade Photo</label>
                    <div class="d-flex align-items-start gap-2">
                        <input type="file" name="shades[${count}][image]" class="form-control shade-image-input" accept="image/*">
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                previewContainer.html(`
                    <img src="${e.target.result}" class="rounded shadow-sm border" style="width:100px; height:100px; object-fit:cover;">
                `);
            }

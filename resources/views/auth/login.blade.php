            ...
            <div class="card border-0 shadow-sm overflow-hidden">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-pink small text-decoration-none" style="color: #ec4899;">Forgot?</a>
                                @endif
                            </div>
                            <input type="password" 
                                   name="password" 
                        ...
                        <button type="submit" class="btn btn-pink w-100 py-2 fw-bold shadow-sm mb-3" style="background-color: #ec4899; color: white; border: none;">
                            Sign In
                        </button>
                    </form>
                    ...
                    <div class="text-center mt-3">
                        <p class="text-muted small">New here? 
                            <a href="{{ route('register') }}" class="text-pink fw-bold text-decoration-none" style="color: #ec4899;">Create account</a>
                        </p>
                    </div>
                </div>
            </div>
